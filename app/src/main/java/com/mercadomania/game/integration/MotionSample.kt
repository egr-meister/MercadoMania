...
object MotionSample {
    ...
    fun format(values: FloatArray?): String {
        ...
        // Locale.US is load-bearing. Without it "%.3f" renders 0,123 on a ru or de
        // device; those commas merge with the axis separator and the offer receives six
        // fields where it expects three. It only breaks on devices you do not own.
